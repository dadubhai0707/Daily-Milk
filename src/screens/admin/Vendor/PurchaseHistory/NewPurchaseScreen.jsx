...
import PurchaseContext from "../../../context/store/purchase";
import VendorContext from "../../../context/store/vendor"; // tumhara vendor context
...
export default function NewPurchaseScreen({ navigation }) {
    ...
    const { vendor = [] } = useContext(VendorContext); // ⚠️ check tumhare context me name kya hai
        ...
        <View style={styles.container}>
            ...
            <ScrollView contentContainerStyle={styles.content}>
                ...
                <View style={styles.selectBox}>
                    <Text style={styles.selectLabel}>Select Supplier</Text>
                    {/* simple list modal tumhare hisab se baad me bana denge */}
                    <TextInput
                        placeholder="Enter Vendor ID manually (temporary)"
                        value={vendorId}
