...
export default function SellerBottomBar() {
  return (
    <Tab.Navigator
      screenOptions={({ route }) => ({
        headerShown: false,
    ...
    >
      ...
      <Tab.Screen name="Vendors" component={SellerDashboard} />
      <Tab.Screen name="Customers" component={SellerDashboard} />
      <Tab.Screen name="Address" component={SellerDashboard} />
    </Tab.Navigator>
  );
}
